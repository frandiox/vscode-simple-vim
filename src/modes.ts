...
const configToStyleMapping: {
  [key in CursorConfigurationStyle]: vscode.TextEditorCursorStyle
} = {
...
function isValidCursorConfigStyle(
  input: any
): input is CursorConfigurationStyle {
  return (
    typeof input === 'string' &&
    Object.keys(configToStyleMapping).indexOf(input) !== -1
  )
}
